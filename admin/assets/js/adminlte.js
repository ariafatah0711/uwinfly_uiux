...
(function (global, factory) {
  ...
  class PushMenu {
    ...
    addSidebarBreakPoint() {
      ...
      const sidebarExpand =
        Array.from(sidebarExpandList).find((className) => className.startsWith(CLASS_NAME_SIDEBAR_EXPAND)) ?? "";
  ...
  class AccessibilityManager {
    ...
    handleMenuNavigation(event) {
      ...
      const menuItems = Array.from(
        currentElement.closest(".nav, .navbar-nav, .dropdown-menu")?.querySelectorAll("a, button") || []
      );
